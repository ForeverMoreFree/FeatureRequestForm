...
aren't certain where to host. Once your project is completed, please email your hiring manager.
...
5. *MVVM Frontend*. The modern web is highly interactive. Projects like Knockout.js make it very easy to deploy HTML bindings that interact with interface elements dependably and efficiently.